...
let objAnswers = [
    ['images/triangle.png', 'images/square.png', 'images/circle.png', 2, 'Circle', 'sounds/circle.mp3'],
    ['images/parallelogram.png', 'images/hexagon.png', 'images/oval.png', 1, 'Hexagon', 'sounds/hexagon.mp3'],
    ['images/oval.png', 'images/rhombus.png', 'images/trapezoid.png', 0, 'Oval', 'sounds/oval.mp3'],
    ['images/rectangle.png', 'images/square.png', 'images/parallelogram.png', 2, 'Parallelogram', 'sounds/parallelogram.mp3'],
    ['images/circle.png', 'images/rectangle.png', 'images/oval.png', 1, 'Rectangle', 'sounds/rectangle.mp3'],
    ['images/rhombus.png', 'images/triangle.png', 'images/square.png', 0, 'Rhombus', 'sounds/rhombus.mp3'],
    ['images/hexagon.png', 'images/trapezoid.png', 'images/square.png', 2, 'Square', 'sounds/square.mp3'],
    ['images/circle.png', 'images/star.png', 'images/rectangle.png', 1, '5 point star', 'sounds/star.mp3'],
    ['images/trapezoid.png', 'images/square.png', 'images/star.png', 0, 'Trapezoid', 'sounds/trapezoid.mp3'],
    ['images/parallelogram.png', 'images/hexagon.png', 'images/triangle.png', 2, 'Triangle', 'sounds/triangle.mp3']
]
